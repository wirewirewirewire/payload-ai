...
export interface Config {
  ...
  collectionsSelect: {
    ...
    random: RandomSelect<false> | RandomSelect<true>;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "random_select".
 */
export interface RandomSelect<T extends boolean = true> {
  alt?: T;
  updatedAt?: T;
  createdAt?: T;
}
